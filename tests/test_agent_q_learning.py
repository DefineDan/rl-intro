import pytest
import numpy as np
from rl_intro.agent.agent_q_learning import AgentQLearning, AgentConfig
...
def make_agent(n_states=3, n_actions=2, seed=42):
    ...
    return AgentQLearning(config, DummyPolicy(PolicyConfig()))
...
def test_learn_non_terminal():
    ...
    terminal = False
    next_state = 1
    next_action = 0  # Not used in Q-Learning
